...
export namespace Collection {
  export type Type = 'list' | 'sector' | 'tag'
  export type Name = List | Sector | string
}
...
// L.
export type List = 'mostactive' | 'gainers' | 'losers' | 'iexvolume' | 'iexpercent' | 'infocus'
...
// R.
export type Range = 'dynamic' | '1d' | '1m' | '3m' | '6m' | 'ytd' | '1y' | '2y' | '5y' | string
...
// S.
export type Sector = 'Financials' | 'Health Care' | 'Consumer Staples' | 'Communication Services' | 'Utilities' | 'Real Estate' | 'Technology' | 'Energy' | 'Materials' | 'Industrials' | 'Consumer Discretionarystring'
